...
function extractAuctionSnapshot(auctionDetails = {}) {
  const runtimeUtils = getRuntimeUtils();
  if (runtimeUtils?.extractAuctionSnapshot) {
    return runtimeUtils.extractAuctionSnapshot(auctionDetails);
  }
...
function applyRuntimeTargeting(auctionSnapshot, context = {}) {
  const runtimeUtils = getRuntimeUtils();
  if (runtimeUtils?.applyRuntimeTargeting) {
    return runtimeUtils.applyRuntimeTargeting(
